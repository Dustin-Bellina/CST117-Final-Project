...
void deathMenu(playerType& player) {
    ...
    cout << "Another adventurer has fallen.\n\n";
    ...
    cout << "Press SPACE to return to the main menu." << endl;
...
void winMenu(playerType& player) {
	...
	cout << "The hero returns home, victorious from their adventure in the sewer.\n\n";
	cout << "Final Stats:\n";
	cout << "Health: " << player.health << "\n";
	cout << "Strength: " << player.strength << "\n";
	cout << "Armor: " << player.armor << "\n";
